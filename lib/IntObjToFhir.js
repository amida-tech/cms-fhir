        ...
        "drug code": function (value) {
            if (!_.include(result, medication)) {
                ...
                if (!_.include(result, medicationDispense)) {
                    medicationDispense.resource.medication["reference"] = medication.resource.id;
...
Factory.prototype.drugs = function (cms, patient, empty, source) {
    ...
    if (medication) {
        medicationPrescription.resource.medication = {
            "reference": medication.resource.id
        };
...
Factory.prototype.selfReportedVitalStatistics = function (cms, patient) {
    ...
    var selfReportedLabsAndTestsMapper = {
        ...
        "date": function (value) {
            return {
                "appliesDateTime": normaliseDateTime(value)
            };
        },
        "time": function (value) {
            return {
                "appliesDateTime": normaliseDateTime(observation.resource["appliesDateTime"] + " " + value)
            };
        },
