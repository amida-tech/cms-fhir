...
mapper["drugs"] = function(memo, value, index, list) {
    _.forEach(memo.factory.drugs(value, memo.patient),
        function(val, key) {
            memo.bundle.entry.push(val);
        }
    );
...
mapper["preventive services"] = function(memo, value, index, list) {
    ...
    _.forEach(memo.factory.preventiveServices(value, memo.patient),
        function(val, key) {
            memo.bundle.entry.push(val);
        }
    );
...
mapper["plans"] = function(memo, value, index, list) {
    _.forEach(memo.factory.pansInsuranceSubsidy(value, memo.patient),
        function(val, key) {
            memo.bundle.entry.push(val);
        }
    );
...
Factory.prototype.pansInsuranceSubsidy = function(cms, patient) {
   ...
   var self = this;
    ...
    var organization = {
      ...
      var pisMapper = {
        ...
        "plan period": function(value) {
            ...
            if(period.length === 2 ) {
                return ( period[1] === 'current')? { "period":{ "start": normaliseDateTime(period[0])}}:
                { "period":{ "start":normaliseDateTime(period[0]), "end":normaliseDateTime(period[1])}}; 
            } else {
                return { "period":{ "start": normaliseDateTime(period[0])}};
            };
        },
        ...
        "plan type": function(value) {
            var tmp = value.split(' - ');
            if(tmp.length === 2 ) {
                return {"type": [ { "code":tmp[0],  "display": tmp[1]}]};
            } else {
        ...
        "employer subsidy start date": function(value) {
            return {"period": { "start": normaliseDateTime(value)}};
        },
        "employer subsidy end date": function(value) {
            return {"period": { "end": normaliseDateTime(value)}};
        },
        ...
        "policy number": function(value) {
                return {"subscriberId":  { "value":value }};
        },
    ...
    if(organization.resource.name || organization.resource.address) {
        ...
        pis.resource["issuer"] = { "reference": organization.resource["id"] };
...
Factory.prototype.preventiveServices = function(cms, patient) {
    var self = this;
    var result = [];
...
Factory.prototype.drugs = function(cms, patient) {
    var self = this;
    var result = [];
